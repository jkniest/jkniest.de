...
window.swiper = __webpack_require__(7);
...
$(window).scroll(function () {
    ...
    try {
        ...
        for (var _iterator = $('.info-box')[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var box = _step.value;
